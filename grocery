...
private List price=Arrays.asList(40,20,40,200,50,50,50,50,30,80,90,10,50,640,35,20,40,20,30);
...
private void add()
{
	...
	item.put(103,"Rice");
	item.put(104,"Wheat");
    item.put(105,"toordal");
    item.put(106,"uraddal");
    item.put(107,"mongdal");
    item.put(108,"eggs");
    item.put(109,"peas");
